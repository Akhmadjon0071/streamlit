...
with cl1:
    with st.expander("Category_ViewData"):
        # st.write(category_df.style.background_gradient(get_cmap="Blues"))
...
with cl2:
    with st.expander("Region_ViewData"):
        ...
        # st.write(region.style.background_gradient(get_cmap="Oranges"))
...
st.subheader(":point_right: Month wise SubCategory Sales Aummary")
